...
def main():
    ...
    parser.add_argument('--checkpoint_path',type = str, default='/home/ubuntu/hxh/tl/Caltch_finetune/',
    ...
    parser.add_argument('--root-dir', type=str, default='/home/ubuntu/yxy/tl-ssl/data/Caltech256',
    ...
    parser.add_argument('--transfer-resume', type=str, default='/home/ubuntu/hxh/tl/checkpoint_epoch_0200.pth.tar',
                        help='Path to load transfering pretrained model')
    parser.add_argument('--resume', type = str, default='./checkpoint/Caltch_finetune/best.pth.tar',
    ...
    for epoch in range(args.start_epoch, args.epoch):
        ...
        if np.max(metric) == acc1:
            ...
            torch.save(checkpoint, '/home/ubuntu/hxh/tl/Caltch_finetune/best.pth.tar')
            print("Model Saved")
