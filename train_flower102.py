from model import Densenet, Inceptionv3, ResNet, VGG
...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='./flower_finetune/',
    ...
    # parser.add_argument('--root-dir', type=str, default='/home/ubuntu/hxh/102Flower',
    #                     help='path to the image folder')
    parser.add_argument('--root-dir', type=str, default='/home/ubuntu/yxy/tl-ssl/data/102Flower',
                        help='path to the image folder')
    ...
    parser.add_argument('--transfer-resume', type=str, default='/home/ubuntu/hxh/tl/moco_v2_800ep_pretrain.pth.tar',
