...
def main():
    ...
    parser.add_argument('--checkpoint-path',type = str, default='/home/ubuntu/hxh/tl-ssl/tl/0.01tl_pretrain',
    ...
    # parser.add_argument('--resume', type = str, default='/home/ubuntu/hxh/tl-ssl/tl/tl_pretrain/best.pth.tar',
    ...
    trainset = datasets.ImageFolder(
        '/home/ubuntu/hxh/SUN397',
        transforms.Compose(augmentation))

    origin_len = len(trainset)
    trainset, _ = torch.utils.data.random_split(trainset, [int(0.01 * len(trainset)),
                                                                                origin_len - int(
                                                                                    0.01 * len(trainset))])
    valset = datasets.ImageFolder('/home/ubuntu/hxh/SUN397', test_trans)
